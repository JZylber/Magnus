from piezas import Rook, Bishop, Queen, Knight, Pawn
...
class TestPieceCapture:
    ...
    def test_piece_capture_none(clean_board:Board):
        ...
        clean_board.set_piece((0,0),Rook("white"))
    ...
    @staticmethod
    def test_piece_capture(clean_board:Board):
        white_player,black_player = Player("white"),Player("black")
        clean_board.set_piece((0,0),Rook("white"))
        ...
        assert isinstance(state,TurnStart)
    @staticmethod
    def test_change_selected_piece(clean_board:Board):
        white_player,black_player = Player("white"),Player("black")
        clean_board.set_piece((0,0),Rook("white"))
        clean_board.set_piece((0,1),Knight("white"))
        clean_board.set_piece((1,0),Pawn("black"))
        state = PieceSelected(white_player,black_player,(0,0),clean_board,{})
    ...
    @staticmethod
    def test_invalid_capture(clean_board:Board):
        white_player,black_player = Player("white"),Player("black")
        clean_board.set_piece((0,0),Bishop("white"))
        clean_board.set_piece((1,0),Pawn("black"))
        state = PieceSelected(white_player,black_player,(0,0),clean_board,{})
        state = state.onClick((1,0))
        assert len(white_player.captured_pieces()) == 0
        ...
        assert isinstance(state,PieceSelected)
    @staticmethod
    def test_invalid_movement(clean_board:Board):
        white_player,black_player = Player("white"),Player("black")
        clean_board.set_piece((0,0),Bishop("white"))
        state = PieceSelected(white_player,black_player,(0,0),clean_board,{})
